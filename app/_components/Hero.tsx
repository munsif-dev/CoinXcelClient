    ...
    <>
      <div className="flex items-center justify-between w-full">
        ...
        <div className="w-1/2 flex flex-col space-y-3">
          <AnimatedText
            type="h1"
            text="Revolutionizing Crypto Trading!"
            className="w-[845px] text-[#008037] text-[80px] font-bold leading-[90px]"
          />
          <p className="w-[600px] text-[#006400] text-lg font-medium font-['Poppins'] leading-[30px]">
            {`"Experience seamless, secure, and innovative crypto trading with our platform. 
              From managing portfolios to making informed decisions, we’ve got you covered."`}
          </p>
      ...
      <div className="w-full flex justify-center items-center mt-20 pt-16 "></div>
    </>
  );
};
